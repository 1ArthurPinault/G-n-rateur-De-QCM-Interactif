...
# ─── Phase 2 : Écran création de profil ─────────────────────────────────────
...
# ─── Phase 2 : Panneau profil (modal avec 3 onglets) ────────────────────────
...
# ─── Phase 2 : Modal modification de profil ─────────────────────────────────
...
# ─── Phase 3 : Overlay animation montée de rang ────────────────────────────
...
# ─── Écran de lancement (modifié Phase 2 : bande profil en haut) ────────────
